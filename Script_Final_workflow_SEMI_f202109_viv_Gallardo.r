...
# Test con Undersampling y muchas menos iteracione, que la corrida anterior
    #semillerio = 28,   # cantidad de semillas finales
    #repeticiones_exp = 2
...
FEintra_manual_base <- function( pinputexps )
{
  ...
  param_local$meta$script <- "/src/wf-etapas/1301_FE_intraMes_modeloFinal.r"
...
TS_strategy_base9 <- function( pinputexps )
{
  ...
  param_local$final_train$undersampling <- 0.21
  ...
  param_local$train$training <- c(202103, 202102, 202101, 202012, 202011, 202010, 202009, 202008, 202007, 202005, 202004, 
                                  202003, 202002, 202001, 201912, 201911, 201910, 201909, 201908)
  param_local$train$validation <- c(202105, 202104, 202103, 202006, 202004)
  ...
  param_local$train$undersampling <- 0.21
